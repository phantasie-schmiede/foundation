...
/**
 * Make sure there is one blank line between different types of class elements.
 * This is a clone of \PhpCsFixer\Fixer\ClassNotation\ClassAttributesSeparationFixer.
 * Only method determineRequiredLineCount() is changed.
 *
 ...
 */
final class ClassBlockSeparationFixer extends AbstractFixer implements ConfigurableFixerInterface, WhitespacesAwareFixerInterface
{
    ...
    public function getDefinition(): FixerDefinitionInterface
    {
        return new FixerDefinition(
            'Ensures exactly one blank line between trait import, constant and property blocks in class-like structures.',
            [
                new CodeSample(
                    "<?php\nclass Demo\n{\n    use FirstTrait;\n\n\n    const FLAG = true;\n\n    private string \$name;\n}\n"
                ),
    ...
    {
        return 'PSBits/class_block_separation';
    }
    ...
    private function determineRequiredLineCount(Tokens $tokens, array $class, int $elementIndex): int
    {
        ...
        $currentType = $class['elements'][$elementIndex]['type'];
        $previousType = $class['elements'][$elementIndex + 1]['type'];
        ...
        $previousIsHeader = \in_array($previousType, $headerTypes, true);

        if ($currentIsHeader && $previousIsHeader) {
            return $currentType === $previousType ? 1 : 2;
        }

        if ('method' === $currentType && $previousIsHeader) {
            return 2;
        }
